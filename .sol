...
// Connect with us: 
// https://t.me/pepenero_official_bsc
// https://pepenero.io
// https://twitter.com/PepeNero_bsc
...
contract PepeNero is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PepeNeroDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PepeNero", "PPN") {
        marketingWallet = payable(0x2C684a3F9cab5490AbF140ad2E1dBb220150B208);
        devWallet = payable(0x4236B3811ED7D1838fB27c9401E9D1D44c483dac);
        ...
        dividendTracker = new PepeNeroDividendTracker(
            payable(this),
            router,
...
contract PepeNeroDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PepeNero public PepeNeroContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PepeNeroContract = PepeNero(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PepeNero_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PepeNero_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PepeNero contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PepeNeroContract);

            uint256 prevBalance = PepeNeroContract.balanceOf(address(this));
            ...
            {
                uint256 received = PepeNeroContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PepeNeroContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
